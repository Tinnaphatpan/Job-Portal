    ...
    <div>
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
        ...
        <button
          ...
          className="w-full py-3 rounded-full border border-gray-200 text-gray-700 font-semibold text-sm flex items-center justify-center gap-3 hover:bg-gray-50 transition-all"
        >
